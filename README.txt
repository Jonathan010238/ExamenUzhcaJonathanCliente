...
a persistence unit "ExamenUzhcaJonathanClientePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenUzhcaJonathanCliente\pom.xml":
...
artifact ("ExamenUzhcaJonathanCliente.war") is already built. You can build
